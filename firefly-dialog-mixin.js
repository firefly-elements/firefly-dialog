 ...
 * @mixinFunction
 */
export const FireflyDialogMixin = (superclass) => class extends superclass {
     ...
     */
     _addCard(){
        ...
        let assignedNodes = nodes.filter( n => n.nodeType === Node.ELEMENT_NODE && matchesSelector(n, '.detail-page'));
